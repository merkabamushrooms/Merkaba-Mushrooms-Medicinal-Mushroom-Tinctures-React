        ...
        <div className="footer-gray-container">
          <div className="footer-gray-container1">
            <div className="footer-gray-container2">
              ...
              />
              <span className="footer-gray-text">Merkaba Mushrooms</span>
            ...
            <div className="footer-gray-container4">
              <div className="footer-gray-container5">
                ...
                <span className="footer-gray-text05 Large">Mushroom Tools</span>
              ...
              <div className="footer-gray-container7">
                ...
                <span className="footer-gray-text14 Large"> Research</span>
                <span className="footer-gray-text15 Large">Development</span>
                <span className="footer-gray-text16 Large">Sponsorships</span>
              </div>
              <div className="footer-gray-container8">
                <span className="footer-gray-text17 Large">Legal</span>
                <span className="footer-gray-text18 Large">
                  Terms &amp; Conditions
                </span>
                <span className="footer-gray-text19 Large">Privacy Policy</span>
              </div>
            </div>
          </div>
          <span className="footer-gray-text20 Small">
            All rights reserved. Copyright © 2022 Merkaba Mushrooms
          </span>
        </div>
      </footer>
      <style jsx>
